                                     ...
                                     int* height, int* format, void** buffer)
{
    ...
    OSMesaContext context = window->context.osmesa.handle;

    // Query OSMesa for the color buffer data
    int result = OSMesaGetColorBuffer(context,
                                      &mesaWidth, &mesaHeight, &mesaFormat,
                                      &mesaBuffer);
    if (result)
    {
                                     ...
                                     void** buffer)
{
    ...
    // Query OSMesa for the color buffer data
    int result = OSMesaGetDepthBuffer(context,
